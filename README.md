...
[![CI](https://img.shields.io/github/actions/workflow/status/eliashaeussler/valinor-xml/ci.yaml?label=CI&logo=github)](https://github.com/eliashaeussler/valinor-xml/actions/workflows/ci.yaml)
